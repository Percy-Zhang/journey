...
export type NewDayScreenNavigationProps = NativeStackNavigationProp<NativeStackParamsList, 'NewDay'>;
export type SettingsScreenNavigationProps = NativeStackNavigationProp<NativeStackParamsList, 'Settings'>;
export type ChangePinScreenNavigationProps = NativeStackNavigationProp<NativeStackParamsList, 'ChangePin'>;
export type VerifyPinScreenNavigationProps = NativeStackNavigationProp<NativeStackParamsList, 'VerifyPin'>;
